...
function _years(personalid){return(
personalid.map(item => item.Year)
)}

function _5(yCounts,years,personalid)
{
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("years")).define("years", ["personalid"], _years);
  main.variable(observer()).define(["yCounts","years","personalid"], _5);
