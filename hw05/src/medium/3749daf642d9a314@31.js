...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["simple@1.json", {url: new URL("./simple@1.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], _1);
  main.variable(observer("simple")).define("simple", ["FileAttachment"], _simple);
  main.variable(observer("drag")).define("drag", ["d3"], _drag);
  main.variable(observer("medium1")).define("medium1", ["d3","simple","drag","invalidation"], _medium1);
  main.variable(observer("medium2")).define("medium2", ["d3","simple","drag","invalidation"], _medium2);
  main.variable(observer("medium3")).define("medium3", ["d3","simple","drag","invalidation"], _medium3);
  return main;
}
