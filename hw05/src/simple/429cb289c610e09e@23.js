...
export default function define(runtime, observer) {
  ...
  main.variable(observer("simple2")).define("simple2", ["d3","simple","drag","invalidation"], _simple2);
  main.variable(observer("simple3")).define("simple3", ["d3","simple","drag","invalidation"], _simple3);
  return main;
}
